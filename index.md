...
This is a link to a [working model](https://docs.google.com/spreadsheets/d/1ytkoezTa2jqzolOJAj1-p2oFGiPQ0ocLpr78r8AhdLM/edit?usp=sharing) that estimates netspace growth based on current initial estimate, growth rate, and total storage market size for the upper limit of growth. The Chia team reviewed a very early version in a community Zoom call [Farming and Electricity Usage in Chia](https://youtu.be/oGTBMKVXRuA)
