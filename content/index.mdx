...
- Add annual energy in TWh, compare vs BTC & ETH using [digiconimist ](https://digiconomist.net/bitcoin-energy-consumption)([cbeci](https://cbeci.org/) still great but recent China policy changes not reflected in annual consumption avg)
