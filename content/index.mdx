...
Chia power is the working model for estimating power consumption on the Chia network, written by Jonmichael Hands, head of storage at Chia and formerly Strategic Planner at Intel corporation. You can find him on Keybase as @Storage_jm
...
![power](images/powerbtc.svg "pbtc")
...
![equation](images/image1.png "Eave")
![equation](images/image2.png "Elow")
![equation](images/image3.png "Ehigh")

Where TB/W for P ave, low, and high are estimated with the representative farming equipment efficiency.
![equation](images/image4.png "TB/W")
Total power of the Chia network
![equation](images/image5.png "Ptotal")
Annual energy consumption
![equation](images/image6.png "Etotal")![equation](images/image7.png "Etotal2")
...
![Storage Market](images/image14.png "Market")
...
![HDD Power](images/image13.png "Power")
...
![HDD Power](images/powerw_tb.svg "Power W/TB")
...
![equation](images/image8.png "Elow")
...
![equation](images/image12.png "Pplot")
